  ...
  const markers = [
    {
      ...
      style: { top: '801px', left: '1403px', rotate: '' },
    },
    {
      id: MarkerTypes.Om,
      ref: omRef,
      className: markersClass.female,
      style: { top: '124px', left: '313px', rotate: '180deg' },
    },
    {
      id: MarkerTypes.Sw,
      ref: swRef,
      className: markersClass.male,
      style: { top: '90px', left: '1526px', rotate: '270deg' },
    },
    {
      id: MarkerTypes.Pmo,
      ref: pmoRef,
      className: markersClass.female,
      style: { top: '451px', left: '1186px', rotate: '180deg' },
    },
    {
      id: MarkerTypes.Back,
      ref: backRef,
      className: markersClass.female,
      style: { top: '573px', left: '868px', rotate: '270deg' },
    },
    {
      id: MarkerTypes.Test,
      ref: testRef,
      className: markersClass.male,
      style: { top: '124px', left: '728px', rotate: '180deg' },
    },
    {
      id: MarkerTypes.Analyst,
      ref: analystRef,
      className: markersClass.female,
      style: { top: '298px', left: '1344px', rotate: '90deg' },
    },
  ];
